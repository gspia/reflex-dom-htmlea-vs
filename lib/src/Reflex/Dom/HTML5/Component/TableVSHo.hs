...
{-|
Module      : Reflex.Dom.HTML5.Component.TableVSHo
...
module Reflex.Dom.HTML5.Component.TableVSHo where
          ...
          V.forM vec
            (mkTdElem (\tdc actst -> do
              ...
              let dasa = _activeStateActive actst
                  ...
                  dtxt4 = fmap (\c -> (": "::Text) <> (T.pack . show) c) dgls
              dynText dtxt
              dynText dtxt2
              dynText dtxt3
              dynText dtxt4
